...
function start_game() {
    ...
    number_mvs = 0;
    document.getElementById('launch').textContent="ReStart";
}
...
function back_to_normal(){
    document.getElementById('tab_grid').style.background=null;
    
    setTimeout(reset_images,500);
}
            ...
            case 'p11':
                ...
                if(check_win()){
                    setTimeout(function(){
                        ...
                        document.getElementById('tab_grid').style.background='url("./Congrats.gif")';
                        document.getElementById('tab_grid').style.backgroundSize="cover"

                        setTimeout(back_to_normal,3000)
                    },500);
                }
                break;
